...
void listarItensPedido(int produtos[], int quantidade);
...
int main() {
    ...
    int quantidade_produtos = MAX_PRODUTOS; // Variável para controlar a quantidade de produtos cadastrados
    ...
    do {
        ...
        switch (opcao) {
            case 1:
                cadastrarProduto(produtos, &quantidade_produtos);
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                excluirProduto(produtos, &quantidade_produtos);
                break;
            case 5:
                while (pedido1.repeticao) {
                    ...
                    if (pedido1.carrinho == 0) {
                        ...
                        break;
                    } else if (pedido1.carrinho < 1 || pedido1.carrinho > quantidade_produtos) {
                ...
                if (pedido1.total > 0) {
                    listarItensPedido(pedido1.produtos, MAX_PRODUTOS);
